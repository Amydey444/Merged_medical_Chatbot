...
def process_image(image_path, query):
    try:
        ...
        model1_response = make_api_request("meta-llama/llama-4-scout-17b-16e-instruct")
        model2_response = make_api_request("meta-llama/llama-4-scout-17b-16e-instruct")

        responses = {}

        for model, response in [("model1", model1_response), ("model2", model2_response)]:
